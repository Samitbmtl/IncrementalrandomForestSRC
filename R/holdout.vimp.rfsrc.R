holdout.vimp.irfsrc <- function(formula, data,
                               ...
                               ...)
{
  ...
  ##
  ## --------------------------------------------------------------
  ## pull unnamed parameters to pass to irfsrc
  ...
  p <- length(irfsrc(formula, data, nodedepth = 1, ntree = 1, splitrule = "random")$xvar.names)
  ...
  o <- do.call(irfsrc.grow, c(list(formula = formula, data = data, ntree = ntree,
...
holdout.vimp <- holdout.vimp.irfsrc
## --------------------------------------------------------------
##
