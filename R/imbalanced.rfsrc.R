imbalanced.irfsrc <- function(formula, data, ntree = 3000,
                 ...
                 ...)
{
  ...
  ##-----------------------------------------
  ##
  ## irfsrc call - depends on what's requested
  ##
  ##-----------------------------------------
  ##----------------------------------------
  ## brf method
  ...
  if (method == "brf") {
    ...
    o <- irfsrc(formula, data, ntree = ntree, 
               perf.type = perf.type,
