           ...
           ...)
{
  ...
  if (grepl("surv", family) || grepl("IndSurvB", family) || grepl("HET", family) || grepl("indQuadC", family) || grepl("indQuad2C", family) || grepl("indLSC", family) || grepl("indTSTC", family) || grepl("indTST2C", family) || grepl("indNSRC", family)  || grepl("indMOB0C", family) || grepl("CMB", family) || grepl("indMOBQC", family) || grepl("indMaxLC", family) || grepl("indMaxQC", family) || grepl("indMaxMaxQC", family)) {
    ptn.count <- 0
  }
  ## ---------------------------------------------------------------- 
...
# 	  parallel::stopCluster(cl_compile)
	  	  ...
	  	  no_cores <-parallel::detectCores()
	  	  cl_compile<- parallel::makeCluster(no_cores)
	  	  predicted <- parallel::parSapply(cl_compile,1:nrow(irfsrcOutput$membership), fun_pred,Objyvar,ObjMembership,irfsrcOutput$membership,Objinbag)
	  	  parallel::stopCluster(cl_compile)
	}
	if (grepl("HET", irfsrcOutput$family))
	{
	  #print("C Ok")
	  	  no_cores <-parallel::detectCores()
	  	  cl_compile<- parallel::makeCluster(no_cores)
	...
	if (grepl("CMB", irfsrcOutput$family))
	{
	  #print("C Ok")
		no_cores <-parallel::detectCores()
		cl_compile<- parallel::makeCluster(no_cores)
	...
	##Sami
	if (grepl("IndSurvB", irfsrcOutput$family) || grepl("HET", irfsrcOutput$family) || grepl("indQuadC", irfsrcOutput$family) || grepl("indQuad2C", irfsrcOutput$family) || grepl("indLSC", irfsrcOutput$family) || grepl("indTSTC", irfsrcOutput$family) || grepl("indTST2C", irfsrcOutput$family) || grepl("indNSRC", irfsrcOutput$family)  || grepl("indMOB0C", irfsrcOutput$family) || grepl("CMB", irfsrcOutput$family) || grepl("indMOBQC", irfsrcOutput$family) || grepl("indMaxLC", irfsrcOutput$family) || grepl("indMaxQC", irfsrcOutput$family) || grepl("indMaxMaxQC", irfsrcOutput$family))
	{
		predicted.oob <- NULL
	}
