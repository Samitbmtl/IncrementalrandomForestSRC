...
//Sami
#define RF_debugPrint Debug_printR
...
#define SURV_SGS    19
//Sami
#define INDS_SPLIT  20
#define INDLINEARC  21
#define INDQUADC    22
#define INDQUAD2C   23
#define INDTSTC     24
#define INDNSRC     25
...
#define INDMAXLC    30
#define INDMAXQC    31
#define INDMAXMAXQC 32
#define INDCAT      33
#define IND_SURV_CAT 34
#define MAXM_SPLIT  99 
#define BL_NONE      0
#define BL_MULT      1
#define BL_DIVS      2
#define BL_ADDT      3
...
char MaxKMCat(uint       treeID,
                ...
                char       multImpFlag);  				
//Sami
char F_indIncrementalCategoricalSplit(uint       treeID,
                                      Node      *parent,
                                      uint      *repMembrIndx,
                                      uint       repMembrSize,
                                      uint      *allMembrIndx,
                                      ...
                                      GreedyObj *greedyMembr,
                                      char       multImpFlag);
//char F_indLinearCSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indQuadCSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indQuad2CSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indTSTCSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indTST2CSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indNSRCSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
char F_indIncrementalGenericSplit(uint       treeID,
	Node      *parent,
	uint      *repMembrIndx,
	uint       repMembrSize,
	uint      *allMembrIndx,
	...
	GreedyObj *greedyMembr,
	char       multImpFlag);
//char F_indMOB0CSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indMOBLCSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indMOBQCSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indMaxLCSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indMaxQCSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//	GreedyObj *greedyMembr,
//	char       multImpFlag);
//char F_indMaxMaxQCSplit(uint       treeID,
//	Node      *parent,
//	uint      *repMembrIndx,
//	uint       repMembrSize,
//	uint      *allMembrIndx,
...
//Sami
SEXP extractBBOPid(SEXP sexp_nbr_training,
	SEXP sexp_nbr_test,
	SEXP sexp_nbr_trees,
	SEXP sexp_ObjMembership,
	SEXP sexp_Objinbag,
	SEXP sexp_PrMembership,
	SEXP sexp_GetInBag,
	SEXP sexp_ObsUniqueInTree
);
//Sami
SEXP extractBBOP(SEXP sexp_nbr_training,
	SEXP sexp_nbr_test,
	SEXP sexp_nbr_trees,
	SEXP sexp_nbr_ycols,
	SEXP sexp_ObjMembership,
...
//Sami
SEXP extractBeta(SEXP sexp_nbr_training,
	SEXP sexp_nbr_test,
	SEXP sexp_nbr_trees,
	SEXP sexp_nbr_ycols,
	SEXP sexp_ObjMembership,
...
SEXP rfsrcGrow(SEXP traceFlag,
               ...
               //Sami
               SEXP incTailType ,
               SEXP incMinObsControl,
               SEXP incMinObsTreatment,
               SEXP incTreatmentLowBound,
               SEXP incTreatmentUpperBound
               );
...
//Sami
void Debug_printR(int debuglevel, char *format, ...);
